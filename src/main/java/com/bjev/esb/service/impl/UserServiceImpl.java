...
import com.bjev.esb.common.utils.PasswordUtils;
...
import com.bjev.esb.mapper.localdb.sysbase.SysDeptMapper;
import com.bjev.esb.mapper.localdb.sysbase.SysUserMapper;
...
public class UserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements UserService {
  ...
  public LoginRespVO login(LoginReqVO vo) {
    ...
    String token = httpSessionService.createTokenAndUser(sysUser, getRolesByUserId(sysUser.getId()),
        getPermissionsByUserId(sysUser.getId()));
