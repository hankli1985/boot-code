...
import com.bjev.esb.service.SysDictService;
...
public class SysDictController {
  ...
  public DataResult add(@RequestBody SysDictEntity sysDict) {
    ...
    SysDictEntity q = sysDictService
        .getOne(Wrappers.<SysDictEntity>lambdaQuery().eq(SysDictEntity::getName, sysDict.getName()));
    if (q != null) {
  ...
  public DataResult findListByPage(@RequestBody SysDictEntity sysDict) {
    Page<SysDictEntity> page = new Page<>(sysDict.getPage(), sysDict.getLimit());
