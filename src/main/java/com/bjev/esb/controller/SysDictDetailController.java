...
public class SysDictDetailController {
  ...
  public DataResult findListByPage(@RequestBody SysDictDetailEntity sysDictDetail) {
    Page<SysDictDetailEntity> page = new Page<>(sysDictDetail.getPage(), sysDictDetail.getLimit());
  ...
  @PostMapping("/dictDetail/tree")
  // @ApiOperation(value = "获取机构列表接口")
  // @LogAnnotation(title = "机构管理", action = "获取所有组织机构")
  // @RequiresPermissions("sys:dept:list")
  public DataResult getDictByName(@RequestBody String name) {
    return DataResult.success(sysDictDetailService.list(name));
  }
}
