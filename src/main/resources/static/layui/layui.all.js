...
!(function (e) {
  ...
  (n.prototype.cache = o),
    ...
    (n.prototype.device = function (t) {
      ...
      return (
        t && !r[t] && (r[t] = n(t)), (r.android = /android/.test(o)), (r.ios = 'ios' === r.os), r
      );
    }),
  ...
  (C.prototype = []),
    ...
    (T.prototype.position = function () {
      var e = this,
        ...
        o = function (e) {
          return (
            (e = e ? 'scrollLeft' : 'scrollTop'), document.body[e] | document.documentElement[e]
          );
        },
        s = function (e) {
    ...
    (T.prototype.change = function (e) {
      ...
      return {
        prevYear: function () {
          s('sub') ||
            (a.year--, t.checkDate('limit').calendar(), n.range || t.done(null, 'change'));
        },
        prevMonth: function () {
...
!(function (e, t) {
      ...
      if (((n = e.getAttribute(r)), 'string' == typeof n)) {
        try {
          n =
            'true' === n ||
            ('false' !== n &&
              ('null' === n ? null : +n + '' === n ? +n : qe.test(n) ? pe.parseJSON(n) : n));
        } catch (i) {}
        pe.data(e, t, n);
      } else n = void 0;
    }
  ...
  (pe.fn = pe.prototype = {
    ...
    pe.extend({
      ...
      makeArray: function (e, t) {
        var r = t || [];
        return (
          null != e && (n(Object(e)) ? pe.merge(r, 'string' == typeof e ? [e] : e) : ae.call(r, e)),
          r
        );
      },
    ...
    var t,
      ...
      c = {
        ...
        fireWith: function (e, n) {
          return (
            i || ((n = n || []), (n = [e, n.slice ? n.slice() : n]), s.push(n), t || l()), this
          );
        },
        fire: function () {
        ...
        if (void 0 === e) {
          if (this.length && ((i = pe.data(o)), 1 === o.nodeType && !pe._data(o, 'parsedAttrs'))) {
            for (n = a.length; n--; )
              a[n] &&
                ((r = a[n].name),
                0 === r.indexOf('data-') && ((r = pe.camelCase(r.slice(5))), u(o, r, i[r])));
  ...
  pe.extend({
    ...
    clone: function (e, t, n) {
      ...
      return (
        (r = h(o, 'script')), r.length > 0 && g(r, !u && h(e, 'script')), (r = s = i = null), o
      );
    },
      ...
      pe.cssHooks[t] = {
        ...
        set: function (e, n, r) {
          ...
          return _(
            e,
            n,
            r ? F(e, t, r, fe.boxSizing && 'border-box' === pe.css(e, 'boxSizing', !1, i), i) : 0
          );
        },
      };
    }),
          ...
          .on('mouseover', function () {
            ...
            e.elemTemp.find('.' + d).html(u),
              'vertical' === t.type
                ? e.elemTemp
                    .find('.' + d)
                    .css({ bottom: s + '%', 'margin-bottom': '20px', display: 'inline-block' })
      ...
      var e = this,
        ...
        r = i(
          [
            ...
            '<span ' +
              ('rgb' == o.format && o.alpha ? 'class="layui-colorpicker-trigger-bgcolor"' : '') +
              '>',
            ...
            var e,
              ...
              v = function (i, l) {
                (t(i.target).parent().hasClass(n) && !l) ||
                  (t('.' + a).removeClass(a + 'ed ' + a + 'up'), e && d && e.val(d)),
                  (e = null);
              },
              y = function (i, u, f) {
                var y,
                  ...
                  [
                    ...
                    (function (e) {
                      ...
                      return (
                        ...
                        0 === t.length &&
                          t.push('<dd lay-value="" class="' + c + '">没有选项</dd>'),
                        t.join('')
                      );
                    })(r.find('*')) + '</dl>',
                    '</div>',
    ...
    (b.prototype.checkClick = function (e, a) {
      ...
      l.on('click', 'input[same="layuiTreeCheck"]+', function (r) {
        ...
        var l = i(this).prev(),
          c = l.prop('checked');
        l.prop('disabled') ||
          (n.setCheckbox(e, a, l), t.oncheck && t.oncheck({ elem: e, checked: c, data: a }));
      });
    }),
    (b.prototype.operate = function (e, a) {
      ...
      l.children('.layui-tree-btnGroup').on('click', '.layui-icon', function (l) {
        ...
        if ('add' == f) {
          ...
          n.confirm(
            '确认删除该节点 "<span style="color: #999;">' + (a.title || '') + '</span>" 吗？',
            function (a) {
              if (
                (r.operate && r.operate(g),
                (g.status = 'remove'),
                  ...
                  var l = function (e) {
                    if (e.parents('.' + s)[0]) {
                      ...
                      0 == r.checked &&
                        ...
                        1 == c &&
                          1 == d &&
                          ((r.checked = !0), t.renderForm('checkbox'), l(n.parent('.' + s))));
                    }
                  };
                  l(e);
                }
  ...
  (j.prototype.config = {
    ...
    (j.prototype.render = function () {
      ...
      a.height &&
        ...
        ((e.fullHeightGap = a.height.split('-')[1]), (a.height = R.height() - e.fullHeightGap)),
        e.setInit();
      var l = a.elem,
        n = l.next('.' + v),
            ...
            d = [
              '<td data-field="' +
                ...
                (function () {
                  var e = [];
                  return (
                    n.hide && e.push(f), n.field || e.push('layui-table-col-special'), e.join(' ')
                  );
                })() +
                '">',
              '<div class="layui-table-cell laytable-cell-' +
      ...
      i.layBody
        .on('change', '.' + W, function () {
          var e = t(this),
            ...
            o = d.cache[i.key][n];
          (o[l] = a),
            layui.event.call(this, y, 'edit(' + p + ')', v.call(this, { value: a, field: l }));
        })
        .on('blur', '.' + W, function () {
          var e,
            a = t(this),
    ...
    (v.prototype.render = function () {
      ...
      (i.elem = a(i.elem)),
        parseInt(i.value) !== i.value &&
          (i.half ||
            (i.value =
              Math.ceil(i.value) - i.value < 0.5 ? Math.ceil(i.value) : Math.floor(i.value)));
      for (
        var n = '<ul class="layui-rate" ' + (i.readonly ? 'readonly' : '') + '>', u = 1;
        u <= i.length;
        u++
      ) {
        var r =
...
layui.define(['layer', 'form'], function (t) {
  ...
  (c.prototype.set = function (t) {
    ...
    (c.prototype.setContent = function (t, i, a) {
      var l = u(t);
      l[0] &&
        (a ? e(l[0].document.body).append(i) : e(l[0].document.body).html(i), layedit.sync(t));
    }),
