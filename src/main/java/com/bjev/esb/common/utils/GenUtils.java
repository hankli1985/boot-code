package com.bjev.esb.common.utils;

import com.bjev.esb.common.exception.BusinessException;
import com.bjev.esb.entity.ColumnEntity;
import com.bjev.esb.entity.TableEntity;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table, List<Map<String, String>> columns,
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "com.bjev" : mainPath;
        // 封装模板数据
    ...
    public static String getFileName(String template, String className, String packageName) {
        ...
        if (template.contains("list.html.vm")) {
            return "main" + File.separator + "resources" + File.separator + "templates" + File.separator
                    + className.toLowerCase() + File.separator + "list" + ".html";
        }
